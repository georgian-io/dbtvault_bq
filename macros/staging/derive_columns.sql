{%- macro bigquery__derive_columns(source_relation=none, columns=none) -%}
...
{%- if columns is mapping and columns is not none -%}
    ...
    {%- for col in columns -%}
        {%- if dbtvault.is_list(columns[col]) -%}
            ...
            /* BQ: Had to overwrite due to the use of CONCAT_WS */
            {%- set concat_string = dbtvault_bq.concat_ws(column_list) ~ "  AS " ~ col -%}
